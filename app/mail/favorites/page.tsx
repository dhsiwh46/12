      ...
      <div className="relative z-10">
        ...
        <main className="max-w-[420px] mx-auto px-5 pt-20 pb-10">
          {favorites.length > 0 ? (
            ...
            <div className="bg-black/30 rounded-[18px] overflow-hidden border border-white/20 shadow-xl p-4 space-y-3">
              <div className="flex flex-col items-center justify-center py-12 space-y-4">
                <div className="bg-white/10 p-6 rounded-full">
                  <Icon name="inbox" className="w-12 h-12 text-white/40" />
                </div>
                <div className="text-center space-y-2">
                  <p className="text-[17px] font-semibold text-white/80 drop-shadow-md">
                    暂无收藏
                  </p>
                  <p className="text-[14px] text-white/50 drop-shadow-sm">
                    在临时邮箱页面点击星标添加收藏
                  </p>
                </div>
              </div>
